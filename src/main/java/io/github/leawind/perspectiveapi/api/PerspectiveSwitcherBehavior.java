...
public interface PerspectiveSwitcherBehavior extends PerspectiveSwitcher {
  ...
  ///
  /// During Perspective API resolution, this method is called before each main-camera render
  /// update. A failure is logged and treated as `null` for that render update.
